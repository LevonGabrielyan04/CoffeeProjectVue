<template>
    ...
    <div class = "header">
    <img class="header-image" src = "http://127.0.0.1:8000/img/cropped-Omerta_Logo@3x-1 1.png" alt="Logo" />
        <div class = "header-bar-small-text-bar">
            ...
            <router-link class = "header-bar-small-text" :to="{ name:'card', params:{user_id: user.id}}"  v-if="user"><strong>Card</strong></router-link>
        </div>
...
<div  class="big-image">
<img style="width: 100%;" src="http://127.0.0.1:8000/img/hero.png" >
</div>
<div id = "ribbon_header">
